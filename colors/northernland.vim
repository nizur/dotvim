" Vim color file - northernland
" Maintainer:   Chris Ruzin <thatguy@chrisruzin.net>
...
let g:colors_name="northernland"
" ===== :he highlight-groups
hi Normal             gui=NONE       guifg=White         guibg=#001020       guisp=NONE

hi StatusLine         gui=NONE       guifg=White         guibg=#660000
hi StatusLineNC       gui=NONE       guifg=Black         guibg=DarkGray
hi VertSplit          gui=NONE       guifg=Black         guibg=DarkGray

hi Cursor             gui=NONE       guifg=White         guibg=#990000
hi CursorIM           gui=NONE       guifg=White         guibg=#990000
hi CursorLine                                            guibg=#00172E
hi CursorColumn                                          guibg=#00172E
...
hi Visual             gui=NONE       guifg=White         guibg=#330000
hi VisualNOS          gui=underline  guifg=White         guibg=#330000
...
hi Identifier        gui=bold,italic guifg=#1790BF      "---lighter
